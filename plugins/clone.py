...
from utils import temp, get_time
...
async def clone_menu(client, message):
    ...
    if bot_found:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ', callback_data=f"bot_auto_delete_setgs#{bot['bot_id']}")
        ],[
        ...
        await message.reply(f"<b>ʏᴏᴜʀ ᴄʟᴏɴᴇ ʙᴏᴛ - @{bot['username']}\n\nɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴍᴏᴅɪꜰʏ ʏᴏᴜʀ ᴄʟᴏɴᴇ ʙᴏᴛ ᴛʜᴇɴ ᴅᴏ ɪᴛ ꜰʀᴏᴍ ʜᴇʀᴇ.</b>\n\nɴᴏᴛᴇ - ɪꜰ ᴄʟᴏɴᴇ ʙᴏᴛ ɴᴏᴛ ᴜsɪɴɢ ᴀʟᴏɴɢ ᴏɴᴇ ᴡᴇᴇᴋ ᴛʜᴇɴ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴄʟᴏɴᴇ ʙᴏᴛ ᴅᴇᴀᴄᴛɪᴠᴀᴛᴇ.\n\nʟᴀsᴛ ᴜsᴇᴅ - <code>{last_used}</code> ᴀɢᴏ", reply_markup=InlineKeyboardMarkup(buttons))
    else:
